...
def run_experiment(n_blocks=1):
    ...
    for block_num in range(1, n_blocks + 1):
        ...
        for trial_num, isOddball in enumerate(trialSequence, 1):
            ...
            win.callOnFlip(send_triggers, [0,0,0,0,0,0,0,1]) # show the stimulus and send the trigger
            ...
            # End the trigger pulse after 0.5 seconds
    ...
    # Close the connection to the serialport and the window
    s.close()
    win.close()
    return results
